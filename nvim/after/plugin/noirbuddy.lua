...
Color.new('red_bg', '#3F0001')
Color.new('red_bg_diff', '#901011')
Color.new('red_dark', '#DB5762')
Color.new('red', '#E06C75')
Color.new('yellow_bg', '#282300')
Color.new('yellow_bg_diff', '#4d3702')
Color.new('yellow', '#F7B267')
Color.new('light_yellow', '#F9C48B')
Color.new('green_bg', '#002800')
Color.new('green_bg_diff', '#035F01')
...
Group.new('DiffAdd', colors.green, colors.green_bg)
Group.new('DiffChange', nil, colors.yellow_bg)
Group.new('DiffRemove', colors.red, colors.red_bg)
...
Group.new('diffText', colors.yellow, colors.yellow_bg_diff)
Group.new('diffOldFile', colors.red_bg)
Group.new('diffNewFile', colors.green_bg)
Group.new('diffadded', nil, colors.green_bg)
Group.new('diffremoved', nil, colors.red_bg)
